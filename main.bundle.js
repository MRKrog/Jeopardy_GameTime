...
/* harmony default export */ __webpack_exports__["default"] = (Clues);
...
/* harmony import */ var _Clue_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Clue.js */ "./src/Clue.js");
...
/* harmony import */ var _Category_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./Category.js */ "./src/Category.js");
...
class Game {
  constructor() {
    ...
    this.allClues = [];
    this.roundsArray = [];
    this.rndInst = new _Round_js__WEBPACK_IMPORTED_MODULE_3__["default"](0);
    this.finalWagers = [];
  }
  ...
  startGame(p1, p2, p3) {
    ...
    _domUpdates_js__WEBPACK_IMPORTED_MODULE_6__["default"].buildGameBoard(this, 0);
  }
  ...
  buildRoundTwo(game) {
    ...
    _domUpdates_js__WEBPACK_IMPORTED_MODULE_6__["default"].buildGameBoard(game, 4);
  }

  buildRoundThree(game) {
    this.rndInst.filterArr(game, this.categoryArray, this.allClues, 8, 9);
    _domUpdates_js__WEBPACK_IMPORTED_MODULE_6__["default"].buildFinalRound(game, 8);
  }

  createPlayers(p1, p2, p3) {
    let playerInst1 = new _Player_js__WEBPACK_IMPORTED_MODULE_0__["default"](p1);
    let playerInst2 = new _Player_js__WEBPACK_IMPORTED_MODULE_0__["default"](p2);
    let playerInst3 = new _Player_js__WEBPACK_IMPORTED_MODULE_0__["default"](p3);
    this.playerArray.push(playerInst1);
    this.playerArray.push(playerInst2);
    this.playerArray.push(playerInst3);
    _domUpdates_js__WEBPACK_IMPORTED_MODULE_6__["default"].buildScoreBoard(this.playerArray);
  }

  createClues() {
    Object.values(_Data_js__WEBPACK_IMPORTED_MODULE_5__["default"].clues).forEach(clue => {
      this.allClues.push(new _Clue_js__WEBPACK_IMPORTED_MODULE_1__["default"](clue.question, clue.pointValue, clue.answer, clue.categoryId));
    });
  }

  createCategories() {
    Object.entries(_Data_js__WEBPACK_IMPORTED_MODULE_5__["default"].categories).forEach(category => {
      this.categoryArray.push(new _Category_js__WEBPACK_IMPORTED_MODULE_4__["default"](category[0].replace(/([a-z])([A-Z])/g, '$1 $2').toUpperCase(), category[1]));
    });
  }
  ...
  getClue(cardId) {
    ...
    card[cardId] instanceof _dailyDouble_js__WEBPACK_IMPORTED_MODULE_2__["default"] ? _domUpdates_js__WEBPACK_IMPORTED_MODULE_6__["default"].showDailyDbl(this, card[cardId]) : _domUpdates_js__WEBPACK_IMPORTED_MODULE_6__["default"].showQuestion(this, card[cardId]);
  ...
  updatePlayerScore(game, points) {
    ...
    _domUpdates_js__WEBPACK_IMPORTED_MODULE_6__["default"].changePlayerScore(game);
  ...
  inputFinalRoundWagers(game) {
    _domUpdates_js__WEBPACK_IMPORTED_MODULE_6__["default"].showFinalWager(game);
  }
}
...
class Player {
  ...
  changePlayer(game, player) {
    _domUpdates_js__WEBPACK_IMPORTED_MODULE_0__["default"].removePlayerPosition(game);
    switch (player) {
    case 0:
      game.activePlayer = 1;
      break;
    ...
    _domUpdates_js__WEBPACK_IMPORTED_MODULE_0__["default"].addPlayerPosition(game);
  }
}
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _domUpdates_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./domUpdates.js */ "./src/domUpdates.js");
/* harmony import */ var _dailyDouble_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./dailyDouble.js */ "./src/dailyDouble.js");
...
class Rounds {
  ...
  createDailyDoubles() {
    ...
    const dailyInstance = new _dailyDouble_js__WEBPACK_IMPORTED_MODULE_1__["default"](randomClue.question, randomClue.pointValue, randomClue.answer, randomClue.categoryId);
  ...
  checkAnswer(game, userAnswer) {
    userAnswer === game.rndInst.currentAnswer ? _domUpdates_js__WEBPACK_IMPORTED_MODULE_0__["default"].correctGuess(game) : _domUpdates_js__WEBPACK_IMPORTED_MODULE_0__["default"].wrongGuess(game);
  }
  checkStage(game) {
  ...
  secondRound(game) {
    _domUpdates_js__WEBPACK_IMPORTED_MODULE_0__["default"].clearBoard(game);
  }
  thirdRound(game) {
    _domUpdates_js__WEBPACK_IMPORTED_MODULE_0__["default"].clearBoard(game);
  }
  checkThirdRound(game) {
    game.rndInst.stage === 2 && this.cardCount === -3 ? _domUpdates_js__WEBPACK_IMPORTED_MODULE_0__["default"].endGame(game) : _domUpdates_js__WEBPACK_IMPORTED_MODULE_0__["default"].showFinalQuestion(game);
  }
}
...
module.exports = "images/jpBackground.jpg";
...
class DailyDouble extends _Clue_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  ...
  updatePointValue(game, wager) {
    ...
    if (thisWager >= 5 && thisWager <= maximumWager) {
      ...
      _domUpdates_js__WEBPACK_IMPORTED_MODULE_1__["default"].removeDailyBoard();
    } else {
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  buildScoreBoard: function(playerArray) {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.game-logo').remove();
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.game-title').fadeOut(200, function() {
      jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).remove();
    });
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.form-selection').fadeOut(200, function() {
      jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).remove();
    });
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('footer').append(
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('#startBtn').attr('data-after', 'Quit');
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('body').prepend(`<article class="question-container"></article>`);
  },

  buildGameBoard: function(game, titleIndex) {
    let $innerBoard = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.question-container');
    ...
    game.roundsArray[i].forEach((arr, index) => {
      ...
      titleIndex++;
      arr.forEach((subArr) => {
        jquery__WEBPACK_IMPORTED_MODULE_0___default()(`#col_${index}`).append(`<div class="card" id="${counter}">$${subArr.pointValue}</div>`);
        counter++
      });
    });
  },
  ...
  correctGuess: function(game) {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.answer-container').prepend(`
  ...
  removeQuestions: function() {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.answer-container').fadeOut(1000, function() {
      jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).remove();
    });
  },

  disableCard: function(event) {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(event.target).addClass('card-disabled')
  },
  ...
  changePlayerScore: function(game) {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default()($currentPlayer).text(game.playerArray[game.activePlayer].score);
    game.playerArray[game.activePlayer].changePlayer(game, game.activePlayer);
  },

  addPlayerPosition: function(game) {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(`#player_${game.activePlayer}`).addClass('active-player');
  },

  removePlayerPosition: function(game) {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(`#player_${game.activePlayer}`).removeClass('active-player');
  },

  clearBoard: function(game) {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.round-title').remove();
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.question-container section').fadeOut(500, function() {
      jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).remove();
    });
    setTimeout(function() {
  ...
  removeDailyBoard: function() {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.daily-double-title').fadeOut(500, function() {
      jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).remove();
    });
  },
  ...
  showFinalWager: function(game) {
    if (game.activePlayer > 2) {
      game.activePlayer = 0;
      jquery__WEBPACK_IMPORTED_MODULE_0___default()('.daily-double-title').remove();
      jquery__WEBPACK_IMPORTED_MODULE_0___default()('.final-round-container').remove();
      jquery__WEBPACK_IMPORTED_MODULE_0___default()('.instructions').remove();
  ...
  endGame: function(game) {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.answer-container').remove();
...
module.exports = "images/jepLogo.png";
...
/* harmony import */ var _images_jepLogo_png__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./images/jepLogo.png */ "./src/images/jepLogo.png");
/* harmony import */ var _images_jepLogo_png__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_images_jepLogo_png__WEBPACK_IMPORTED_MODULE_3__);
...
/* harmony import */ var _dailyDouble_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./dailyDouble.js */ "./src/dailyDouble.js");
/* harmony import */ var _domUpdates_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./domUpdates.js */ "./src/domUpdates.js");
...
let game = new _Game_js__WEBPACK_IMPORTED_MODULE_5__["default"]();

// ****************************
// Event listeners
jquery__WEBPACK_IMPORTED_MODULE_4___default()('#startBtn').on('click', () => {
  startGameBtn();
});

jquery__WEBPACK_IMPORTED_MODULE_4___default()('body').on('click', '.card', () => {
  questionClicked(event);
});

jquery__WEBPACK_IMPORTED_MODULE_4___default()('body').on('click', '.answerBtn', () => {
  getUserInput(event);
});

jquery__WEBPACK_IMPORTED_MODULE_4___default()('body').on('click', '.finalAnswerBtn', () => {
  getUserInput(event);
});

jquery__WEBPACK_IMPORTED_MODULE_4___default()('body').on('click', '.submit-wager', () => {
  submitWager();
});

jquery__WEBPACK_IMPORTED_MODULE_4___default()('body').on('click', '#quitBtn', () => {
  location.reload();
});

jquery__WEBPACK_IMPORTED_MODULE_4___default()('body').on('click', '.final-submit-wager', () => {
  let wagerValue = jquery__WEBPACK_IMPORTED_MODULE_4___default()('.final-wager-input').val();
  _domUpdates_js__WEBPACK_IMPORTED_MODULE_7__["default"].checkFinalWager(game, parseInt(wagerValue));
});

jquery__WEBPACK_IMPORTED_MODULE_4___default()('input.name-input').keyup(function() {
  var inputValues = jquery__WEBPACK_IMPORTED_MODULE_4___default()('.name-input').filter(function() {
    return this.value !== '';
  })
  inputValues.length === 3 ? jquery__WEBPACK_IMPORTED_MODULE_4___default()('.start-button-container').removeClass('disabled') : jquery__WEBPACK_IMPORTED_MODULE_4___default()('.start-button-container').addClass('disabled');
});
...
function startGameBtn() {
  let p1 = jquery__WEBPACK_IMPORTED_MODULE_4___default()('#nameOne-input').val();
  let p2 = jquery__WEBPACK_IMPORTED_MODULE_4___default()('#nameTwo-input').val();
  let p3 = jquery__WEBPACK_IMPORTED_MODULE_4___default()('#nameThree-input').val();
  game.startGame(p1, p2, p3);
  jquery__WEBPACK_IMPORTED_MODULE_4___default()('.title-extra').remove();
  jquery__WEBPACK_IMPORTED_MODULE_4___default()('.action-button-container').css('display', 'block');
}

function questionClicked(event) {
  let cardId = event.target.id;
  game.getClue(cardId, event);
  _domUpdates_js__WEBPACK_IMPORTED_MODULE_7__["default"].disableCard(event);
}

function getUserInput(event) {
  let userAnswer = jquery__WEBPACK_IMPORTED_MODULE_4___default()(event.target).text();
  game.rndInst.checkAnswer(game, userAnswer);
}

function submitWager() {
  let wager = jquery__WEBPACK_IMPORTED_MODULE_4___default()('.wager-input').val();
  let dailyDb = game.rndInst.questionsArray[game.rndInst.stage].find(clue => {
    return clue instanceof _dailyDouble_js__WEBPACK_IMPORTED_MODULE_6__["default"];
  });
